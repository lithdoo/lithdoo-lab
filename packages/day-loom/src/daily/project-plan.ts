...
export function projectDailyPlan(plan: DailyPlan, transcript?: string): WorldFileChange[] {
  ...
  const files: WorldFileChange[] = [
    ...
    { relativePath: 'current.yaml', content: ['day: ' + plan.day, 'phase: planned', 'last_committed_day: null', ''].join('\n') },
  ];
